	...
	class OpticAttachments
	{
		...
		items[] =
		{
			...
			"optic_Yorris",
			// KT Scopes
			"kt_atacr05_msrti_raptar",
			"kt_atacr07_tremoe3ti_raptar",
			"kt_atacr06_tremoe3ti_raptar",
			"kt_8x_Dot10_up",
			"kt_8x_Dot09_up",
			"kt_8x_Dot05_cqb_side",
			"kt_8x_Dot03_cqb_up",
			"kt_8x_Dot07_side",
			"kt_8x_Dot08_up",
			"kt_8x_Dot_cqb",
			"kt_20x_Round_Dot05_ti_raptar",
			"kt_20x_Round_Dot04_ti_raptar",
			"kt_25x_PMII04_msr_ti_RAPTAR",
			"kt_25x_PMII05_tremoe3_ti_RAPTAR",
			"kt_25x_PMII06_msr_ti_RAPTAR",
			"kt_25x_PMII07_tremoe3_ti_RAPTAR",
			"kt_25x_PMII02_msr_ti",
			"kt_25x_PMII03_msr_ti",
			"kt_specterDR_s",
			"kt_specterDR",
			// CUP Scopes (Not Finised - missing scopes!)
			"CUP_optic_ACOG",
			...
			"CUP_optic_Eotech533_OD",
			"CUP_optic_Eotech533_Coyote",
